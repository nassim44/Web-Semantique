...
public class CoursesService {
    ...
    public void addCourse(String id, String Name,String Description, String Added_Date) {
        if (model == null) {
            loadRDF();
        }

        Resource CourseResource = model.createResource(
                "http://www.semanticweb.org/ahinfo/ontologies/2024/9/untitled-ontology-3#" + id);
        CourseResource.addProperty(RDF.type, model
                .getResource("http://www.semanticweb.org/ahinfo/ontologies/2024/9/untitled-ontology-3#Course"));


        CourseResource.addProperty(
        ...
        CourseResource.addProperty(
                ...
                Description);
        CourseResource.addProperty(
                model.getProperty("http://www.semanticweb.org/ahinfo/ontologies/2024/9/untitled-ontology-3#hasAdded_Date"),
                Added_Date);
...
// Save the updated model back to the RDF file
    ...
    public void updateCourse(String id, String Name,String Description, String Added_Date) {
        ...
        if (CourseRessource != null) {
            ...
            CourseRessource.removeAll(model
                    .getProperty("http://www.semanticweb.org/ahinfo/ontologies/2024/9/untitled-ontology-3#hasAdded_Date"));
            CourseRessource.addProperty(
                    model.getProperty("http://www.semanticweb.org/ahinfo/ontologies/2024/9/untitled-ontology-3#hasAdded_Date"),
                    Added_Date);
    ...
    public void deleteCourse(String id) {
        ...
        // Find the existing carbon footprint resource by name
        Resource CourseResource = model
                .getResource("http://www.semanticweb.org/ahinfo/ontologies/2024/9/untitled-ontology-3#" + id);

        if (CourseResource != null) {
            // Remove the resource from the model
            model.removeAll(CourseResource, null, null);
            model.removeAll(null, null, CourseResource);
    ...
    public String getCourses() {
        ...
        String queryString = "PREFIX ontology: <http://www.semanticweb.org/ahinfo/ontologies/2024/9/untitled-ontology-3#> "
                + "SELECT ?Course ?hasName ?hasAdded_Date ?hasDescription "
                + "WHERE { "
                + "  ?Course a ontology:Course . "
                + "  ?Course ontology:hasName ?hasName . "
                + "  ?Course ontology:hasAdded_Date ?hasAdded_Date . "
                + "  ?Course ontology:hasDescription ?hasDescription . "
                + "}";
        ...
        try (QueryExecution qexec = QueryExecutionFactory.create(query, model)) {
            ...
            while (results.hasNext()) {
                ...
                String CourseName = solution.get("hasName").toString();
                String hasAdded_Date = solution.get("hasAdded_Date").toString();
                String CourseDescription = solution.get("hasDescription").toString();
                String idURL = solution.getResource("Course").toString();
                String id = idURL.split("#")[1];
                // Create or get the JSON object for this Course
                JSONObject CourseObject = CourseMap.getOrDefault(CourseName, new JSONObject());
                if (!CourseObject.has("Course")) {
                    CourseObject.put("id", id);
                    CourseObject.put("Name", CourseName);
                    CourseObject.put("Added_Date", hasAdded_Date);
                    CourseObject.put("Description", CourseDescription);
                    CourseMap.put(CourseName, CourseObject);
                }
            ...
            resultJson.put("Courses", CoursesArray);
    ...
    public String searchCarbonFootprintsByRange(double minValue, double maxValue) {
        ...
        try (QueryExecution qexec = QueryExecutionFactory.create(query, model)) {
            ...
            while (results.hasNext()) {
                ...
                if (!carbonFootprintObject.has("Course")) {
                    carbonFootprintObject.put("Course", carbonFootprintName);
    ...
    public void addInstanceWithRelation(String Course, String reductionStrategyName, double carbonValue,
        ...
        Resource footprintInstance = model.createResource(
                "http://www.semanticweb.org/ahinfo/ontologies/2024/9/untitled-ontology-3#" + Course);
